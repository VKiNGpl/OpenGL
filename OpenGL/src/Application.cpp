...
int main(void)
{
    ...
    window = glfwCreateWindow(960, 540, "Hello Rectangle", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    std::cout << glGetString(GL_VERSION) << std::endl;
    {
        ...
        glm::mat4 proj = glm::ortho(0.0f, 960.0f, 0.0f, 540.0f, -1.0f, 1.0f);     // arguments: left, right, bottom, top edge, near plane, far plane
